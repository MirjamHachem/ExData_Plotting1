...
# Creating the variable for the x-axis for all four plots by Converting the variables Date and Time 
# from character strings into date and time formats and pasting them together.
